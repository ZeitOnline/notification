...
- Optional `settingsHref` on timed notifications: when no stored auto-dismiss duration preference exists yet, shows a companion notification with a configurable call-to-action that opens the auto-dismiss settings page in a new tab.
